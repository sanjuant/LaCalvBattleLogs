...
class BattleLogsStatsOld {
    ...
    static updateStats(count, short, items, rouesType, cost) {
        ...
        BattleLogs.Utils.LocalStorage.setComplexValue(BattleLogs.StatsOld.Settings.StatsRoues, this.__internal__statsRouesData);
        BattleLogs.StatsOld.__internal__updateStatsRouesOutput(statsData);
    }
    ...
    static updateStatsStuffs(stuff, user, opponent=null) {
        ...
        BattleLogs.Utils.LocalStorage.setComplexValue(BattleLogs.StatsOld.Settings.StatsStuffs, this.__internal__statsStuffsData);
